...
public class HealthRecordDto implements Serializable {
    ...
    @ExcelExport(value = "创建者主键id")
    private Long createdUsrId;

    // ============= 患者基本信息 =============
    @ExcelExport(value = "主键，使用雪花算法生成")
    ...
    @ExcelExport(value = "心电图路径，单个路径按下划线分割,多个路径按百分号分割")
    ...
    @ExcelExport(value = "发病时长，分钟，发病时长可以从发病时间和首次医疗接触时间相减直接生成，不用手选")
    ...
    @ExcelExport(value = "院内实施再灌注治疗，待定具体含义")
    ...
    @ExcelExport(value = "患者转运至有PCI能力医院，待定具体含义")
    ...
    @ExcelExport(value = "住院期间用药阿司匹林，有药品名即可")
    ...
    @ExcelExport(value = "出院带药阿司匹林，有药品名即可")
    ...
    @ExcelExport(value = "醛固酮受体拮抗剂适应证，待定具体含义")
    ...
    @ExcelExport(value = "出院健康教育，待定具体含义")
    private String outHstptEducation;

    @ExcelExport(value = "出院后30天内非计划内全因再入院，待定具体含义")
    private String backAllcause;

    @ExcelExport(value = "首诊30天内全因死亡，待定具体含义")
    ...
    @ExcelExport(value = "转移状态，待定具体含义")
    private String transferStatus;

    @ExcelExport(value = "初步诊断，待定具体含义")
    ...
    @ExcelExport(value = "LDL-C检测，生命体征处：这一项可以取消，或者像cTNI那样后边是单位，前面填数也可以 心肌梗死处：mmol/L")
    ...
    @ExcelExport(value = "ACEI/ARB  剂量/频次  每日改为每次")
    private String medicationDischargeAaRate;

    @ExcelExport(value = "抗血小板药物  剂量/频次  每日改为每次")
    ...
    @ExcelExport(value = "调脂药物  剂量/频次  每日改为每次")
    ...
    @ExcelExport(value = "B受体阻阻滞剂  剂量/频次  每日改为每次")
    ...
    @ExcelExport(value = "PCSK9抑制剂  剂量/频次  每日改为每次")
    ...
    @ExcelExport(value = "阿司匹林  剂量/频次  每日改为每次")
